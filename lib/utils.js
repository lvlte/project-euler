...
/**
 * Used by Array.__proto__.occurrences()
 */
function Occurrences () {
  let total = null;
  Object.defineProperty(this, '__total', {
    enumerable: false,
    get () {
      if (total === null)
        total = sumA(Object.values(this));
      return total;
    }
  });
}
...
/**
 * Defines Array.__proto__.occurrences()
 *
 * Counts occurrences of distinct elements in an array.
 *
 * @return {Occurrences} an Occurrences instance
 */
Object.defineProperty(Array.prototype, 'occurrences', {
  enumerable: false,
  configurable: false,
  writable: false,
  value: function() {
    ...
    if (arguments.length) {
      ...
      if (Array.isArray(filter)) {
        let o = new Occurrences();
        for (let i=0; i<filter.length; i++)
          o[filter[i]] = occurrences[filter[i]] || 0;
        occurrences = o;
      }
      else
        occurrences = occurrences[filter] || 0;
    }
    return occurrences;
  }
});
