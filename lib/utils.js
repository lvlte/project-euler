...
module.exports = utils = {
  ...
  * rangeGen(start, stop, step) {
   ...
   *
   * If `cast` is false, each digit is returned as a string instead of a number,
  ...
  digits(n, cast=true) {
    ...
    // d => d.charCodeAt(0)-48 is faster than d => +d or Number().
    return cast && [...''+n].map(d => d.charCodeAt(0)-48) || [...''+n];
  },
