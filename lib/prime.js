...
const { remZero } = require('./utils.js');
...
module.exports = Prime = {
   ...
   */
  isPrime(n) {
    return n === Prime.leastFactor(n) && n != null;
  },
  ...
  getPrimes(limit=100) {
    ...
    let n = 1;
    while ((n+=2) < limit)
      Prime.sieve(n, multiples, primes, limit, 2*n);
  ...
  getNPrimes(N) {
    ...
    while (primes.length < N)
      Prime.sieve(++n, multiples, primes, limit);
