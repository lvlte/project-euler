...
this.solve = function () {
  ...
  // Instead, since we already got two arbitrary triples of the form (c, c, c±1)
  // for any odd integer c such that cMin <= c <= cMax, then for each c we can
  // set a = (c±1)/2, b = √(c² - a²), and check whether or not b is an integer.
